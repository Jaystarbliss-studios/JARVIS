...
from providers.intent_detector import IntentDetector, Intent, IntentResult
from providers.model_selector import ModelSelector, ModelChoice, ModelSelectionResult
...
class TestIntentDetector:
    ...
    def test_detect_reasoning_intent(self):
        ...
        for user_input in inputs:
            result = self.detector.detect(user_input)
            assert result.primary_intent == Intent.REASONING, f"Failed for: {user_input}"
...
class TestModelSelector:
    ...
    def test_complexity_adjustment(self):
        ...
        simple_result = self.selector._adjust_by_complexity(
            {ModelChoice.TINYLLAMA: 0.7, ModelChoice.PHI_2: 0.5},
            complexity=0.2
        )
