...
class LocalCommandInterface:
    ...
    def __init__(self, model_name: str = "mistral"):
        ...
        self.ollama: OllamaEngine | None = None
    ...
    async def init(self) -> bool:
        ...
        try:
            ...
            if not await self.ollama.check_connection():
                console.print("[red]✗ Ollama server not running[/red]", style="bold")
...
Code:"""
        ...
        self.memory.add_task_result(
            task_name="code_generation", result=code, success=True
        )
...
Chat naturally for multi-turn conversations.
    ...
    def _show_memory_stats(self):
        ...
        if isinstance(self.memory.memory, object) and hasattr(
            self.memory.memory, "get_stats"
        ):
