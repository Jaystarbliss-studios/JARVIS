...
class VoiceprintEncryption:
    ...
    def _load_or_create_key(self) -> Fernet:
        ...
        logger.warning(f"Generated new encryption key. You can also set:")
    ...
    def save_encrypted_voiceprint(self, embedding: np.ndarray, 
                                   filepath: str) -> bool:
        """
    ...
    def load_encrypted_voiceprint(self, filepath: str) -> Optional[np.ndarray]:
        """
...
class AuditLogger:
    ...
    def log_enrollment(self, num_samples: int) -> None:
        ...
        self.file_logger.info(f"[ENROLLMENT] New voiceprint created ({num_samples} samples)")
