...
class OfflineSTT:
    ...
    def __init__(
        self,
        model_path: str = "models/speech_recognition/vosk-model-small-en-us-0.15",
...
class WakeWordDetector:
    ...
    def __init__(self, wake_words: list = ["jarvis"], sensitivity: float = 0.5):
        """
        ...
        logger.info("Wake-word detection disabled by default (optional feature)")
        logger.info(
            "To enable: 'pip install pvporcupine' and set config wake_word_enabled=true"
        )
